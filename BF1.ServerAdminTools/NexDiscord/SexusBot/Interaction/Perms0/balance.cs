...
public static partial class SexusBot
{
    public static partial class Interaction
    {
        public static async Task balance() //debug
        {
            ...
            //SCORE
            string score = $"({Vari.NexServerinfo.Team1Score}-{Vari.NexServerinfo.Team2Score})";
            ...
            //CONCLUSION
            string conclusion = "";
            bool unbalanced = Util_BF1.UnbalanceChecker(Vari.NexServerinfo.Team1Score, Vari.NexServerinfo.Team2Score);
            int maxscore = Math.Max(Vari.NexServerinfo.Team1Score, Vari.NexServerinfo.Team2Score);
            int minscore = Math.Min(Vari.NexServerinfo.Team1Score, Vari.NexServerinfo.Team2Score);
            ...
            {
                if(Vari.NexServerinfo.Team1Score > Vari.NexServerinfo.Team2Score)
                {
