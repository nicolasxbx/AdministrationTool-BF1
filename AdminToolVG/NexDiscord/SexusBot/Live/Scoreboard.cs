...
public static partial class SexusBot
{
    public static partial class Live
    {
        ...
        public static (string s_info, string s_t1, string s_t2) Scoreboard_Create()
        {
            ...
            try
            {
                msg_info += $"\n\n🗺 {Ansi.B.Magenta}{Vari.CurrentMapName}{Ansi.None} (🕑{PlayerUtil.SecondsToMMSS(Vari.ServerLiveInfo.Time)})\n\n\n";
                ...
                sb.Append(String.Format(Ansi.B.Blue+"{0,-7}"+Ansi.None+"   {1,5}     {2,5}     "+Ansi.B.White+ "{3,5}   "+Ansi.None+"{4, 10}\n", 
                    "Team 1:", Vari.ServerLiveInfo.Team1Kill, Vari.ServerLiveInfo.Team1Flag, Vari.ServerLiveInfo.Team1Score, spawned1));
                sb.Append(String.Format(Ansi.B.Red+"{0,-7}"+Ansi.None+"   {1,5}     {2,5}     "+Ansi.B.White+ "{3,5}   "+Ansi.None+"{4, 10}\n\n\n", 
                    "Team 2:", Vari.ServerLiveInfo.Team2Kill, Vari.ServerLiveInfo.Team2Flag, Vari.ServerLiveInfo.Team2Score, spawned2));
