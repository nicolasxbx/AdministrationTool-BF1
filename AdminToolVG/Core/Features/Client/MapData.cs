...
public static class MapData
{
    ...
    public static Dictionary<string, string> MapDictNex { get; } = new()
    {
        {"MP_MountainFort", "Grappa"},
        {"MP_Forest", "Argonne"},
        {"MP_ItalianCoast", "Empires"},
        {"MP_Chateau", "Ballroom"},
        {"MP_Scar", "Scar"},
        {"MP_Desert", "Sinai"},
        {"MP_Amiens", "Amiens"},
